...
public class ShoeController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<ShoeResponseDTO> fetchShoes(@RequestHeader Long userId) throws Exception {
        ResponseEntity<ShoeResponseDTO> response = ShoeService.getAllShoes(userId);
        return response;
    }
